package com.dfh.csma.system.config;

import com.dfh.csma.system.shiro.authc.ShiroRealm;
import com.dfh.csma.system.shiro.authc.aop.JwtFilter;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/cityreport/cityreport/importExcel", "anon");//文件上传
